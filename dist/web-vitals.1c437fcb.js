...
parcelHelpers.export(exports, "getCLS", ()=>s1
);
...
var e1, t1, n1, i1, a1 = function(e, t) {
...
}, u1 = "function" == typeof WeakSet ? new WeakSet : new Set, f = function(e, t, n) {
    var i;
    return function() {
    ...
    s && (n = f(e3, i, t), o1(function() {
        s.takeRecords().map(u), n();
    }), c(function() {
        i = a1("CLS", 0), n = f(e3, i, t);
    }));
}, m1 = -1, p1 = function() {
    ...
    return m1 < 0 && (m1 = p1(), v1(), c(function() {
        setTimeout(function() {
            m1 = p1(), v1();
        }, 0);
    })), {
    ...
    var n, i2 = d(), o = a1("FCP"), s = function(e) {
        "first-contentful-paint" === e.name && (p && p.disconnect(), e.startTime < i2.timeStamp && (o.value = e.startTime, o.entries.push(e), u1.add(o), n()));
    }, m = performance.getEntriesByName("first-contentful-paint")[0], p = m ? null : r1("paint", s);
    (m || p) && (n = f(e4, o, t), m && s(m), c(function(i) {
        o = a1("FCP"), n = f(e4, o, t), requestAnimationFrame(function() {
    ...
    var m, p = d(), v = a1("FID"), l = function(e) {
        e.startTime < p.timeStamp && (v.value = e.processingStart - e.startTime, v.entries.push(e), u1.add(v), m());
    }, h = r1("first-input", l);
    m = f(n, v, s), h && o1(function() {
        h.takeRecords().map(l), h.disconnect();
    }, !0), h && c(function() {
        var r;
        v = a1("FID"), m = f(n, v, s), i1 = [], t1 = -1, e1 = null, w(addEventListener), r = l, i1.push(r), g();
    });
}, T = function(e6, t3) {
    var n, i3 = d(), s = a1("LCP"), m = function(e) {
        var t = e.startTime;
        t < i3.timeStamp && (s.value = t, s.entries.push(e)), n();
    }, p = r1("largest-contentful-paint", m);
    if (p) {
        n = f(e6, s, t3);
        var v = function() {
            u1.has(s) || (p.takeRecords().map(m), p.disconnect(), u1.add(s), n());
        };
        [
            "keydown",
            "click"
            ...
            s = a1("LCP"), n = f(e6, s, t3), requestAnimationFrame(function() {
                requestAnimationFrame(function() {
                    s.value = performance.now() - i.timeStamp, u1.add(s), n();
                });
            });
        });
    }
    ...
    t4 = function() {
        try {
            ...
            if (n3.value = n3.delta = t5.responseStart, n3.value < 0) return;
            n3.entries = [
                t5
            ], e7(n3);
        } catch (e) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["e6xvK"], null, "parcelRequire9123")
